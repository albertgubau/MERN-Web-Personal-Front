...
import { Home, Courses, Contact, Blog, Post } from "../pages/web"; // With the index.js in web folder, notice that we can access all the pages only importing the folder
